...
function Footer() {
      ...
      <div className="flex flex-col md:flex-row w-full md:w-[65%] h-auto md:h-[380px] justify-evenly px-6 py-10 mt-10 border border-[#262840] rounded-2xl space-y-6 md:space-y-0">
        ...
        <div className="flex flex-col items-center md:items-start border-t md:border-t-0 md:border-l border-[#262840] p-6 md:w-1/3 space-y-3">
          ...
          <div className="flex mt-8 space-x-4 ">
            <SvgLoader fileName="fb.svg" />
            <SvgLoader fileName="Ln.svg" />
            <SvgLoader fileName="Gh.svg" />
            <SvgLoader fileName="Tw.svg" />
            <SvgLoader fileName="ig.svg" />
          </div>
        </div>

        {/* Newsletter Section */}
        <div className="flex flex-col items-center md:items-start  md:text-left p-6 md:w-1/3">
          ...
          <div className="flex mt-6 items-center bg-white rounded-xl shadow-lg p-2 w-full max-w-sm">
  {/* Search Input */}
  <input
    type="text"
  ...
  {/* Divider */}
  <div className="w-px bg-gray-300 h-4 sm:h-6 mx-2 sm:mx-3"></div>

  <h1 className="text-[#2A27C9] text-xs sm:text-sm whitespace-nowrap">Sign in</h1>
</div>
